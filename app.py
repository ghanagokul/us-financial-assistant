...
# ------------------- Page Config & Styling -------------------
st.set_page_config(page_title="Investment Assistant for Migrants from", layout="centered")
...
st.markdown('<div class="title-style">📊 Personalized Investment Planner for U.S. Migrants</div>', unsafe_allow_html=True)
